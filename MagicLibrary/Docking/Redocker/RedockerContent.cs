...
namespace Junxian.Magic.Docking
{
    ...
    public class RedockerContent : Redocker
    {
		...
		/// <summary>Outerindex field.</summary>
		protected int _outerIndex;
		/// <summary>InsideRect field.</summary>
        protected Rectangle _insideRect;
		/// <summary>OutsideRect field.</summary>
        protected Rectangle _outsideRect;
		/// <summary>TopList field.</summary>
		protected ArrayList _topList;
		/// <summary>BottomList field.</summary>
		protected ArrayList _bottomList;
		/// <summary>LeftList field.</summary>
		protected ArrayList _leftList;
		/// <summary>RightList field.</summary>
		protected ArrayList _rightList;
		/// <summary>FillList field.</summary>
		protected ArrayList _fillList;
