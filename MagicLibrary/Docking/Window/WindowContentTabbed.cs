...
namespace Junxian.Magic.Docking
{
    ...
    public class WindowContentTabbed : WindowContent, IHotZoneSource, IMessageFilter
    {
        ...
        private Junxian.Magic.Controls.TabControl _tabControl;
            ...
            : base(manager, vs)
        {
            ...
            _tabControl = new Junxian.Magic.Controls.TabControl();
        ...
        public override Content CurrentContent
        {
            get
            {
                Junxian.Magic.Controls.TabPage tp = _tabControl.SelectedTab;
		...
		/// </summary>
		public Junxian.Magic.Controls.TabControl TabControl
		{
		...
		public override void BringContentToFront(Content c)
		{
            ...
            foreach(Junxian.Magic.Controls.TabPage page in _tabControl.TabPages)
                if (page.Tag == c)
                {
        ...
        protected override void OnContentInserted(int index, object value)
        {
            ...
            Junxian.Magic.Controls.TabPage newPage = new Junxian.Magic.Controls.TabPage();
		...
		private void OnSelectionChanged(Junxian.Magic.Controls.TabControl tabControl, 
										Junxian.Magic.Controls.TabPage oldPage, 
										Junxian.Magic.Controls.TabPage newPage)
		{
		...
		private void OnDoubleClickTab(Junxian.Magic.Controls.TabControl tc, Junxian.Magic.Controls.TabPage page)
		{
		...
		private void OnPageDragStart(Junxian.Magic.Controls.TabControl sender, 
									 Junxian.Magic.Controls.TabPage movePage, 
									 MouseEventArgs e)
		{
			// Is the user allowed to redock?
			if (DockingManager.AllowRedocking)
		...
		private void OnPageDragEnd(Junxian.Magic.Controls.TabControl sender, MouseEventArgs e)
		{
			// Are we currently in a redocking state?
			if (_redocker != null)
			{
				// Remove the page from the source
				Junxian.Magic.Controls.TabPage removedPage = _tabControl.TabPages[_dragPageIndex];
		...
		private void OnPageDragQuit(Junxian.Magic.Controls.TabControl sender, MouseEventArgs e)
		{
			// Are we currently in a redocking state?
			if (_redocker != null)
			{
		...
		private void OnPageMoved(Junxian.Magic.Controls.TabControl sender, 
								 Junxian.Magic.Controls.TabPage page, 
								 int newIndex)
		{
