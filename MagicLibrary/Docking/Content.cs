...
namespace Junxian.Magic.Docking
{
    ...
    public class Content
    {
		...
		private Office2003Color _office2003BackColor;
        ...
        public Control Control
        {
            ...
            set 
            {
                if (_control != value)
                {
					...
					// A control that is a Panel of Form should have its back color auto set            
					if ((_control != null) && ((_control is Form) || (_control is Panel)))
						Office2003BackColor = Office2003Color.Base;
					else
						Office2003BackColor = Office2003Color.Disable;
		...
		/// </summary>
		public Office2003Color Office2003BackColor
		{
