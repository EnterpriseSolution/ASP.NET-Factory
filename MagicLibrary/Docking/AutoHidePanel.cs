...
namespace Junxian.Magic.Docking
{
    ...
    public class AutoHidePanel : Panel, IMessageFilter
	{
        ...
        public AutoHidePanel(DockingManager manager, DockStyle dockEdge)
		{
			...
			_colorDetails.Style = manager.Style;
		...
		public void PropogateNameValue(PropogateName name, object value)
        {
            switch(name)
            {
				...
				case PropogateName.Style:
					_colorDetails.Style = (VisualStyle)value;
					Invalidate();
					break;
			}
        ...
        public void BringContentIntoView(Content c)
        {
            ...
            foreach(TabStub ts in this.Controls)
            {
                ...
                foreach(Junxian.Magic.Controls.TabPage page in ts.TabPages)
                {
        ...
        public void AddContentsAsGroup(ContentCollection contents, Content current, int index)
		{
            ...
            TabStub ts = new TabStub(_manager.Style, _manager.StubsShowAll);
			...
			Junxian.Magic.Controls.TabPage currentPage = null;
        ...
        public void RemoveContent(Content c)
        {
            ...
            Junxian.Magic.Controls.TabPage targetPage = null;
		...
		protected override void OnPaintBackground(PaintEventArgs e)
        {
            ...
            if (_manager.Style == VisualStyle.IDE)
            {
                ...
                if (_defaultColor)
                    ...
                    backColor = ColorHelper.TabBackgroundFromBaseColor(base.BackColor);
                    
                backBrush = new SolidBrush(backColor);
            }
            else if ((_manager.Style == VisualStyle.IDE2005) && _defaultColor)
			{
            ...
            else if ((_manager.Style == VisualStyle.Office2003) && _defaultColor)
        ...
        private void OnPageContextMenu(Point screenPos)
        {
