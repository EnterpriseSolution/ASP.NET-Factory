...
namespace Junxian.Magic.Controls.Command
{
	/// <summary>
	...
	public class CommandCollectionDialog : Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.labelCollection.Text = "命令集合";
			...
			this.buttonOK.Location = new System.Drawing.Point(392, 388);
			...
			this.buttonCancel.Location = new System.Drawing.Point(480, 388);
			...
			this.buttonAddButton.Text = "添加按钮";
			...
			this.buttonAddSeparator.Text = "添加分隔线";
