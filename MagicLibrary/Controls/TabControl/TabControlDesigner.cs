...
namespace Junxian.Magic.Controls
{
    ...
    public class TabControlDesigner : ParentControlDesigner
    {
        ...
        public override ICollection AssociatedComponents
        {
            get 
            {
                if (base.Control is Junxian.Magic.Controls.TabControl)
                    return ((Junxian.Magic.Controls.TabControl)base.Control).TabPages;
                else
        ...
        protected override void WndProc(ref Message msg)
        {
            ...
            if (msg.Msg == (int)Win32.Msgs.WM_LBUTTONDOWN)
            {
                ...
                Junxian.Magic.Controls.TabControl tabControl = this.SelectionService.PrimarySelection as Junxian.Magic.Controls.TabControl;
