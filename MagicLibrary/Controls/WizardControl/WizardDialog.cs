...
using XmlForm.Magic.Controls;

namespace XmlForm.Magic.Forms
{
	/// <summary>
	...
	public class WizardDialog : System.Windows.Forms.Form
	{
		...
		private void InitializeComponent()
		{
			...
			this.wizardControl = new XmlForm.Magic.Controls.WizardControl();
			this.SuspendLayout();
			// 
			// wizardControl
			// 
			...
			this.wizardControl.WizardPageEnter += new XmlForm.Magic.Controls.WizardControl.WizardPageHandler(this.OnWizardPageEnter);
			...
			this.wizardControl.WizardPageLeave += new XmlForm.Magic.Controls.WizardControl.WizardPageHandler(this.OnWizardPageLeave);
