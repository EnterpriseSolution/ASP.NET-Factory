...
namespace XmlForm.Magic.Controls
{
    ...
    public class WizardControl : UserControl
	{
        ...
        private XmlForm.Magic.Controls.TabControl _tabControl;
        ...
        static WizardControl()
        {
            ...
            _standardPicture = ResourceHelper.LoadBitmap(Type.GetType("XmlForm.Magic.Controls.WizardControl"),
                                                         "XmlForm.Magic.Resources.WizardPicture.bmp");
        }
		...
		private void InitializeComponent()
		{
			...
			this._tabControl = new XmlForm.Magic.Controls.TabControl();
			...
			// _tabControl
			// 
			this._tabControl.Appearance = XmlForm.Magic.Controls.VisualAppearance.MultiDocument;
			...
			this._tabControl.Style = XmlForm.Magic.Common.VisualStyle.IDE;
		...
		/// <summary>
		/// Gets and sets a value indicating is a default button should be assigned.
		/// </summary>
        [Category("Wizard")]
		...
		private void OnTabSelectionChanged(XmlForm.Magic.Controls.TabControl tabControl, 
										   XmlForm.Magic.Controls.TabPage oldPage, 
										   XmlForm.Magic.Controls.TabPage newPage)
        {
