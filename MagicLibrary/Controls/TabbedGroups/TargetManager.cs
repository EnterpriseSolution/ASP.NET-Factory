...
namespace XmlForm.Magic.Controls
{
	...
	public abstract class TargetManager
	{
	    ...
	    {
            _validCursor = ResourceHelper.LoadCursor(Type.GetType("XmlForm.Magic.Controls.TabbedGroups"),
                                                                  "XmlForm.Magic.Resources.TabbedValid.cur");

            _invalidCursor = ResourceHelper.LoadCursor(Type.GetType("XmlForm.Magic.Controls.TabbedGroups"),
                                                                    "XmlForm.Magic.Resources.TabbedInvalid.cur");
        }
