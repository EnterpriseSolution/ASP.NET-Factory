...
namespace XmlForm.Magic.Controls
{
	...
	public class TabGroupLeaf : TabGroupBase
	{
        ...
        // Instance fields
	    private MenuCommand _mcClose;
        private MenuCommand _mcSep1;
        private MenuCommand _mcProm;
        private MenuCommand _mcReba;
        private MenuCommand _mcSep2;
        private MenuCommand _mcPrev;
        private MenuCommand _mcNext;
        private MenuCommand _mcVert;
        private MenuCommand _mcHorz;
        ...
        static TabGroupLeaf()
        {
            ...
            _internalImages = ResourceHelper.LoadBitmapStrip(Type.GetType("XmlForm.Magic.Controls.TabbedGroups"),
                                                             "XmlForm.Magic.Resources.ImagesTabbedGroups.bmp",
            ...
            switch(code)
            {
				...
				case NotifyCode.ProminentChanged:
					...
					if (_tabbedGroups.ProminentLeaf == null)
					{
						...
						{
							if ((_tabbedGroups.Style == VisualStyle.IDE2005) ||
								(_tabbedGroups.Style == VisualStyle.Office2003))
							{
							...
							{
								// Set back the remembered back colors
					...
					else
					{
						...
						if (this == _tabbedGroups.ProminentLeaf)
						{
							...
							if (_tabbedGroups.ProminentColors)
							{
								...
								{
									// Update tab control to use prominent colours
									_tabControl.BackColor = _tabbedGroups.ProminentBackColor;
									_tabControl.ForeColor = _tabbedGroups.ProminentForeColor;
								}
							}
		...
		private void DefinePopupMenuForControl(Controls.TabControl tabControl)
		{
			...
			_mcHorz = new MenuCommand("", _internalImages, IMAGE_HORZ_SPLIT, new EventHandler(OnNewVertical));
			_mcVert = new MenuCommand("", _internalImages, IMAGE_VERT_SPLIT, new EventHandler(OnNewHorizontal));
        ...
        private void OnPopupMenuDisplay(object sender, CancelEventArgs e)
        {
            ...
            {        
				...
				_mcClose.Shortcut = _tabbedGroups.CloseShortcut;
				_mcProm.Shortcut = _tabbedGroups.ProminentShortcut;
				_mcReba.Shortcut = _tabbedGroups.RebalanceShortcut;
				_mcPrev.Shortcut = _tabbedGroups.MovePreviousShortcut;
				_mcNext.Shortcut = _tabbedGroups.MoveNextShortcut;
				_mcVert.Shortcut = _tabbedGroups.SplitVerticalShortcut;
				_mcHorz.Shortcut = _tabbedGroups.SplitHorizontalShortcut;
