...
namespace XmlForm.Magic.Controls
{
    ...
    public class TabbedGroups : UserControl, ISupportInitialize
	{
		...
		private Shortcut _closeShortcut;
        private Shortcut _prominentShortcut;
        private Shortcut _rebalanceShortcut;
        private Shortcut _movePreviousShortcut;
        private Shortcut _moveNextShortcut;
        private Shortcut _splitVerticalShortcut;
        private Shortcut _splitHorizontalShortcut;
        ...
        private bool TestShortcut(Shortcut sc)
        {
            bool result = false;
            ...
            if ((_activeLeaf != null) && !LayoutLock)
            {
                ...
                if (tc.SelectedTab != null)
                {
                    ...
                    if (tc.TabPages.Count > 1)
                    {
                        ...
                        if (sc.Equals(_splitVerticalShortcut))
                        {
							// Remove any prominent setting
							if (ProminentLeaf != null)
								ProminentLeaf = null;
                        ...
                        if (sc.Equals(_splitHorizontalShortcut))
                        {
							// Remove any prominent setting
							if (ProminentLeaf != null)
								ProminentLeaf = null;
		...
		private void OnSelectedChanged(XmlForm.Magic.Controls.TabControl tabControl, 
