...
namespace Junxian.Magic.Common
{
    ...
    public class ThemeColorHelper : IDisposable
	{
        ...
        private static Color[] _ide2005Base1Color = new Color[]{Color.FromArgb(244, 247, 252),
        ...
        private static Color[] _ide2005Base2Color = new Color[]{Color.FromArgb(244, 247, 252),
															    Color.FromArgb(244, 247, 252),
															    Color.FromArgb(244, 247, 252)};
		...
		private static Color[] _ide2005CaptionSelectColor1 = new Color[]{Color.FromArgb(142, 173, 205),
																		 Color.FromArgb(164, 191, 221),
																		 Color.FromArgb(189, 211, 239)};
		...
		private static Color[] _ide2005CaptionSelectColor2 = new Color[]{Color.FromArgb(142, 173, 205),
																		 Color.FromArgb(164, 191, 221),
																		 Color.FromArgb(189, 211, 239)};
        ...
        private static Color[] _ide2005OpenBaseColor1 = new Color[]{Color.FromArgb(142, 173, 205),
																    Color.FromArgb(142, 173, 205),
																    Color.FromArgb(231, 233, 241)};
		...
		public Color ActiveTabColor(VisualStyle style)
		{
			...
			if ((style == VisualStyle.IDE2005) || (_currentTheme == THEME_CLASSIC))
                //return SystemColors.Control;
                return Color.FromArgb(244, 247, 252);
			else
		...
		public Color ActiveBorderColor(VisualStyle style)
		{
			...
			if ((style == VisualStyle.IDE2005) || (_currentTheme == THEME_CLASSIC))
                //return SystemColors.ControlDark;
                return Color.FromArgb(105, 161, 191);
			else
