...
namespace Junxian.Magic.Common
{
	...
	public class DropIndicators : Form
	{
								 ...
								 bool middleV, bool middleA)
		{
			...
			if (leftV)		DrawSquaresLeft(g, leftA);
			if (rightV)		DrawSquaresRight(g, rightA);
			if (topV)		DrawSquaresTop(g, topA);
			if (bottomV)	DrawSquaresBottom(g, bottomA);
			if (middleV)	DrawSquaresMiddle(g, middleA);
		}
								 ...
								 bool middleV, bool middleA)
		{
			...
			Color active = SystemColors.ActiveCaption;
			Color inactive = SystemColors.InactiveCaption;
			
			if (background) DrawDiamondBackground(g, 0, 0); 
			if (leftV)		DrawDiamondLeft(g, leftA ? active : inactive, 0, 31);
			if (rightV)		DrawDiamondRight(g, rightA ? active : inactive, 58, 31);
			if (topV)		DrawDiamondTop(g, topA ? active : inactive, 29, 0);
			if (bottomV)	DrawDiamondBottom(g, bottomA ? active : inactive, 29, 62);
			if (middleV)	DrawDiamondMiddle(g, middleA ? active : inactive, 34, 36);
		...
		private void DrawSquaresLeft(Graphics g, bool active)
		{
			Color borderColour = ControlPaint.Dark(SystemColors.ActiveCaption);
					  ...
					  shadow2Pen = new Pen(shadow2))
			{
				...
				using(LinearGradientBrush middleBrush = new LinearGradientBrush(new Rectangle(4, 33, 23, 1), ControlPaint.LightLight(SystemColors.InactiveCaption), SystemColors.ActiveCaption, 0f),
										  bottomBrush = new LinearGradientBrush(new Rectangle(4, 34, 23, 1), ControlPaint.Light(SystemColors.ActiveCaption), SystemColors.ActiveCaption, 0f),
										  positionBrush = new LinearGradientBrush(new Rectangle(4, 35, 11, 1), Color.FromArgb(160, SystemColors.InactiveCaption), Color.FromArgb(64, SystemColors.InactiveCaption), 0f),
		...
		private void DrawSquaresRight(Graphics g, bool active)
		{
			Color borderColour = ControlPaint.Dark(SystemColors.ActiveCaption);
			Color shadow1 = Color.FromArgb(190, 190, 190);
			Color shadow2 = Color.FromArgb(218, 218, 218);
			...
			{
				// Draw the caption area at top of window
				using(LinearGradientBrush middleBrush = new LinearGradientBrush(new Rectangle(60, 33, 23, 1), ControlPaint.LightLight(SystemColors.InactiveCaption), SystemColors.ActiveCaption, 0f),
										  bottomBrush = new LinearGradientBrush(new Rectangle(60, 34, 23, 1), ControlPaint.Light(SystemColors.ActiveCaption), SystemColors.ActiveCaption, 0f),
										  positionBrush = new LinearGradientBrush(new Rectangle(71, 35, 11, 1), Color.FromArgb(160, SystemColors.InactiveCaption), Color.FromArgb(64, SystemColors.InactiveCaption), 180f),
		...
		private void DrawSquaresTop(Graphics g, bool active)
		{
			Color borderColour = ControlPaint.Dark(SystemColors.ActiveCaption);
			Color shadow1 = Color.FromArgb(190, 190, 190);
			Color shadow2 = Color.FromArgb(218, 218, 218);
			...
			{
				// Draw the caption area at top of window
				using(LinearGradientBrush middleBrush = new LinearGradientBrush(new Rectangle(33, 5, 20, 1), ControlPaint.LightLight(SystemColors.InactiveCaption), SystemColors.ActiveCaption, 0f),
										  bottomBrush = new LinearGradientBrush(new Rectangle(33, 6, 20, 1), ControlPaint.Light(SystemColors.ActiveCaption), SystemColors.ActiveCaption, 0f),
										  positionBrush = new LinearGradientBrush(new Rectangle(34, 6, 19, 10), Color.FromArgb(160, SystemColors.InactiveCaption), Color.FromArgb(64, SystemColors.InactiveCaption), 90f),
		...
		private void DrawSquaresBottom(Graphics g, bool active)
		{
			Color borderColour = ControlPaint.Dark(SystemColors.ActiveCaption);
			Color shadow1 = Color.FromArgb(190, 190, 190);
			Color shadow2 = Color.FromArgb(218, 218, 218);
			...
			{
				// Draw the caption area at top of window
				using(LinearGradientBrush middleBrush = new LinearGradientBrush(new Rectangle(33, 61, 20, 1), ControlPaint.LightLight(SystemColors.InactiveCaption), SystemColors.ActiveCaption, 0f),
										  bottomBrush = new LinearGradientBrush(new Rectangle(33, 62, 20, 1), ControlPaint.Light(SystemColors.ActiveCaption), SystemColors.ActiveCaption, 0f),
										  positionBrush = new LinearGradientBrush(new Rectangle(34, 72, 19, 11), Color.FromArgb(160, SystemColors.InactiveCaption), Color.FromArgb(64, SystemColors.InactiveCaption), 270f),
		...
		private void DrawSquaresMiddle(Graphics g, bool active)
		{
			Color borderColour = ControlPaint.Dark(SystemColors.ActiveCaption);
			Color shadow1 = Color.FromArgb(190, 190, 190);
			Color shadow2 = Color.FromArgb(218, 218, 218);
			...
			{
				// Draw the caption area at top of window
				using(LinearGradientBrush middleBrush = new LinearGradientBrush(new Rectangle(32, 34, 21, 1), ControlPaint.LightLight(SystemColors.InactiveCaption), SystemColors.ActiveCaption, 0f),
										  bottomBrush = new LinearGradientBrush(new Rectangle(32, 35, 21, 1), ControlPaint.Light(SystemColors.ActiveCaption), SystemColors.ActiveCaption, 0f))
				{
					// Draw border
					...
					using(SolidBrush innerBrush = new SolidBrush(Color.FromArgb(64, SystemColors.InactiveCaption)))
					{
		...
		private void DrawDiamondMiddle(Graphics g, Color baseColor, int x, int y)
		{
			using(SolidBrush fillBrush = new SolidBrush(Color.FromArgb(128, SystemColors.ActiveCaptionText)))
			{
		...
		private void DrawDiamondLeft(Graphics g, Color baseColor, int x, int y)
		{
			using(SolidBrush fillBrush = new SolidBrush(Color.FromArgb(128, SystemColors.ActiveCaptionText)))
			{
		...
		private void DrawDiamondRight(Graphics g, Color baseColor, int x, int y)
		{
			using(SolidBrush fillBrush = new SolidBrush(Color.FromArgb(128, SystemColors.ActiveCaptionText)))
			{
		...
		private void DrawDiamondTop(Graphics g, Color baseColor, int x, int y)
		{
			using(SolidBrush fillBrush = new SolidBrush(Color.FromArgb(128, SystemColors.ActiveCaptionText)))
			{
		...
		private void DrawDiamondBottom(Graphics g, Color baseColor, int x, int y)
		{
			using(SolidBrush fillBrush = new SolidBrush(Color.FromArgb(128, SystemColors.ActiveCaptionText)))
			{
