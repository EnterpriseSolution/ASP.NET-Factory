...
namespace Junxian.Magic.Menus
{
    ...
    [Designer(typeof(Junxian.Magic.Menus.MenuControlDesigner))]
    public class MenuControl : ContainerControl, IMessageFilter
    {
        ...
        static MenuControl()
        {
            ...
            _menuImages = ResourceHelper.LoadBitmapStrip(Type.GetType("Junxian.Magic.Menus.MenuControl"),
                                                         "Junxian.Magic.Resources.ImagesMenuControl.bmp",
...
//							Console.WriteLine("Loop {0} {1}", this.Handle, ((Win32.Msgs)msg.message).ToString());
		...
		public bool PreFilterMessage(ref Message msg)
        {
			...
			else
			{
				...
				if (Form.ActiveForm is Junxian.Magic.Docking.FloatingForm)
					snoop = true;
			}
