...
namespace Junxian.Magic.Menus
{
	...
	{
		private Junxian.Magic.Controls.TreeControl treeControl1;
		...
		{
			this.treeControl1 = new Junxian.Magic.Controls.TreeControl();
			...
			this.treeControl1.BorderStyle = Junxian.Magic.Controls.TreeBorderStyle.Solid;
			this.treeControl1.BoxDrawStyle = Junxian.Magic.Controls.DrawStyle.Plain;
			this.treeControl1.CheckDrawStyle = Junxian.Magic.Controls.DrawStyle.Plain;
			...
			this.treeControl1.SelectMode = Junxian.Magic.Controls.SelectMode.Single;
			this.treeControl1.Size = new System.Drawing.Size(204, 380);
			this.treeControl1.TabIndex = 0;
			this.treeControl1.Text = "treeControl1";
			this.treeControl1.AfterSelect += new Junxian.Magic.Controls.NodeEventHandler(this.treeControl1_AfterSelect);
			// 
			// contextMenu
			// 
			...
			this.buttonOK.Location = new System.Drawing.Point(400, 432);
			...
			this.buttonCancel.Location = new System.Drawing.Point(480, 432);
			...
			this.buttonAddChild.Text = "添加子菜单";
		...
		private void AddToNodeCollection(MenuCommandCollection commands, NodeCollection nodes)
		{
			...
			foreach(MenuCommand command in commands)
			{
				...
				clone.PropertyChanged += new Junxian.Magic.Menus.MenuCommand.PropChangeHandler(OnPropertyChanged);
		...
		private void treeControl1_AfterSelect(Junxian.Magic.Controls.TreeControl tc, Junxian.Magic.Controls.NodeEventArgs e)
		{
		...
		private void buttonInsert_Click(object sender, System.EventArgs e)
		{
			...
			// We want to know whenever the menu text is changed
			mc.PropertyChanged += new Junxian.Magic.Menus.MenuCommand.PropChangeHandler(OnPropertyChanged);
		...
		private void OnPropertyChanged(MenuCommand item, Junxian.Magic.Menus.MenuCommand.Property prop)
		{
			if (prop == Junxian.Magic.Menus.MenuCommand.Property.Text)
			{
