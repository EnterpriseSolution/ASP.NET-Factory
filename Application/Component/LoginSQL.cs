    ...
    public class LoginForm : Form
    {
        ...
        private void btn_Ok_Click(object sender, EventArgs e)
        {
            try
            {
                ...
                if ((str2 == "") || (str == ""))
                {
                    MessageBox.Show(this, "服务器或用户名不能为空！", StringResources.Application, MessageBoxButtons.OK, MessageBoxIcon.Asterisk);
                }
                else
                {
                    ...
                    catch (Exception exception)
                    {
                        this.Text = "连接服务器失败！";
                        LogInfo.WriteLog(exception);
                        MessageBox.Show(this, "连接服务器失败！请检查服务器地址或用户名密码是否正确！", StringResources.Application, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                        return;
                    }
                    finally
                    {
                    ...
                    {
                        MessageBox.Show(this, "该服务器已经存在！请更换服务器地址或检查输入是否正确！", StringResources.Application, MessageBoxButtons.OK, MessageBoxIcon.Hand);
                    }
                    else
                    {
        ...
        public void InitializeComponent()
        {
            ...
            this.pictureBox1.Size = new System.Drawing.Size(398, 82);
