...
namespace Flextronics.Applications.ApplicationFactory
{
    ...
    public class FrmDataExport : Form
    {
        ...
        public FrmDataExport(string longservername, string dbname)
        {
        ...
        {
            ResourceManager manager = new ResourceManager(typeof(FrmDbToScript));
