...
namespace Flextronics.Applications.ApplicationFactory
{
    ...
    public class DbView : Form  // KryptonForm
    {
   ...
   //     private LoginOra logoOra = new LoginOra();
        ...
        private void AddSinglePage(Control control, string Title)
        {
            ...
            foreach (Junxian.Magic.Controls.TabPage page2 in this.mainfrm.tabControlMain.TabPages)
            {
                ...
                try
                {
                    ...
                    if (tables.Count > 0)
                    {
                        foreach (string str9 in tables)
                        {
                            ...
                            if (!ConnectSimple)
                            {
                                List<ColumnInfo> columnList = obj2.GetColumnList(str8, str9);
                    ...
                    if (vIEWs != null)
                    {
                        foreach (DataRow row5 in vIEWs.Select("", "name ASC"))
                        {
                           ...
                           // SplashScreen.SetStatus("加载数据库信息 " + str12);
                            ...
                            if (!ConnectSimple)
                            {
                                List<ColumnInfo> list5 = obj2.GetColumnList(str8, str12);
                                if ((list5 != null) && (list5.Count > 0))
                                {
                                    foreach (ColumnInfo info2 in list5)
                                    {
                    ...
                    if (procs != null)
                    {
                        foreach (DataRow row6 in procs.Select("", "name ASC"))
                        {
                         ...
                         //   SplashScreen.SetStatus("加载数据库信息 " + str15);
                            ...
                            if (!ConnectSimple)
                            {
                                List<ColumnInfo> list6 = obj2.GetColumnList(str8, str15);
                                if ((list6 != null) && (list6.Count > 0))
                                {
                                    foreach (ColumnInfo info3 in list6)
                                    {
                ...
                try
                {
                    ...
                    if (tables.Count > 0)
                    {
                        foreach (string str8 in tables)
                        {
                            ...
                            {
                                List<ColumnInfo> columnList = this.dbobj.GetColumnList(dbName, str8);
                                if ((columnList != null) && (columnList.Count > 0))
                                {
                                    foreach (ColumnInfo info in columnList)
                                    {
                ...
                try
                {
                    ...
                    if (vIEWs != null)
                    {
                        foreach (DataRow row5 in vIEWs.Select("", "name ASC"))
                        {
                            ...
                            if (!this.logo.chk_Simple.Checked)
                            {
                                List<ColumnInfo> list5 = this.dbobj.GetColumnList(dbName, str11);
                                if ((list5 != null) && (list5.Count > 0))
                                {
                                    foreach (ColumnInfo info2 in list5)
                                    {
                    ...
                    if (procs != null)
                    {
                        foreach (DataRow row6 in procs.Select("", "name ASC"))
                        {
                           ...
                           // SplashScreen.SetStatus("加载数据库信息 " + str14);
                            ...
                            if (!this.logo.chk_Simple.Checked)
                            {
                                List<ColumnInfo> list6 = this.dbobj.GetColumnList(dbName, str14);
                                if ((list6 != null) && (list6.Count > 0))
                                {
                                    foreach (ColumnInfo info3 in list6)
                                    {
        ...
        private void InitializeComponent()
        {
            ...
            this.treeImgs.Images.SetKeyName(1, "16_4.ico");
            ...
            this.treeImgs.Images.SetKeyName(14, "16_6.ico");
            // 
            // treeView1
            // 
            ...
            this.treeView1.Size = new System.Drawing.Size(244, 342);
            ...
            this.toolStrip1.Size = new System.Drawing.Size(244, 26);
            ...
            this.toolbtn_AddServer.Image = global::WebMatrix.Properties.Resources.toolbtn_AddServer_Image;
            ...
            this.toolbtn_Connect.Image = global::WebMatrix.Properties.Resources._19_3;
            ...
            this.toolbtn_unConnect.Image = global::WebMatrix.Properties.Resources.toolbtn_unConnect_Image;
            ...
            this.toolbtn_Refrush.Image = global::WebMatrix.Properties.Resources.toolbtn_Refrush_Image;
            ...
            this.ResizeEnd += new System.EventHandler(this.DbView_ResizeEnd);
        ...
        private void treeView1_AfterSelect(object sender, TreeViewEventArgs e)
        {
            try
            {
                ...
                FrmCodeMaker maker = (FrmCodeMaker) Application.OpenForms["CodeMaker"];
                if (maker != null)
                {
                    this.mainfrm.lblViewInfo.Text = "正在检索数据库.....";
                ...
                //    rm.SetListView(this);
                //}
                FrmCodeTemplate2 template = (FrmCodeTemplate2) Application.OpenForms["CodeTemplate"];
                if (template != null)
                {
                    this.mainfrm.lblViewInfo.Text = "正在检索数据库.....";
        ...
        private void 查看表数据tabItem_Click(object sender, EventArgs e)
        {
            if (this.TreeClickNode != null)
            {
                ...
                FrmDataList ctrForm = new FrmDataList(ObjectHelper.CreatDbObj(text), dbName, tabName);
        ...
        private void 存储过程dbItem_Click(object sender, EventArgs e)
        {
            ...
            if ((dialog.ShowDialog(this) == DialogResult.OK) && (this.TreeClickNode != null))
            {
                ...
                string pROCCode = ObjectHelper.CreatDsb(text).GetPROCCode(dbname);
        ...
        private void 存储过程tabItem_Click(object sender, EventArgs e)
        {
            ...
            if ((dialog.ShowDialog(this) == DialogResult.OK) && (this.TreeClickNode != null))
            {
                ...
                string dbname = this.TreeClickNode.Parent.Parent.Text;
                string tablename = this.TreeClickNode.Text;
                IDbScriptBuilder builder = ObjectHelper.CreatDsb(text);
                builder.DbName = dbname;
                builder.TableName = tablename;
                builder.ProjectName = this.setting.ProjectName;
                builder.ProcPrefix = this.setting.ProcPrefix;
                builder.Keys = new List<ColumnInfo>();
                builder.Fieldlist = new List<ColumnInfo>();
        ...
        {           
            ...
            {
                this.mainfrm.AddSinglePage(new FrmCodeMaker(mainfrm), "代码生成器");
            }
        }
            ...
            if (dialog.ShowDialog(this) == DialogResult.OK)
            {
                try
                {
                    ...
                    if (File.Exists(fileName))
                    {
                        ...
                        string str2 = Application.StartupPath + @"\Setting.config";
                        set.WriteXml(str2);
                    }
                    this.LoadServer();
                }
        ...
        private void 对象定义Item_Click(object sender, EventArgs e)
        {
            if (this.TreeClickNode != null)
            {
                ...
                string objectInfo = ObjectHelper.CreatDbObj(text).GetObjectInfo(dbName, objName);
        ...
        private void 模版代码生成Item_Click(object sender, EventArgs e)
        {
            if (this.TreeClickNode.Parent.Parent.Parent.Text != "")
            {
                this.mainfrm.AddSinglePage(new FrmCodeTemplate2(this.mainfrm), "模版代码生成器");
            }
        }
        ...
        private void 删除tabItem_Click(object sender, EventArgs e)
        {
            if (this.TreeClickNode != null)
            {
                ...
                string dbName = this.TreeClickNode.Parent.Parent.Text;
                string tableName = this.TreeClickNode.Text;
                IDbObject obj2 = ObjectHelper.CreatDbObj(text);
        ...
        private void 生成ModelItem_Click(object sender, EventArgs e)
        {
            if (this.TreeClickNode != null)
            {
                ...
                CodeBuilders builders = ObjectHelper.CreatCB(text);
                builders.DbName = str2;
                builders.TableName = str3;
                string strSQL = builders.GetCodeFrameS3Model(WCFSupport);
        ...
        private void 生成数据脚本dbItem_Click(object sender, EventArgs e)
        {
            if (this.TreeClickNode != null)
            {
                string text = this.TreeClickNode.Parent.Text;
                string dbname = this.TreeClickNode.Text;
                new FrmDbToScript(text, dbname).ShowDialog(this);
            }
        }
        ...
        private void 生成数据脚本tabItem_Click(object sender, EventArgs e)
        {
            ...
            if ((result == DialogResult.No) && (this.TreeClickNode != null))
            {
                ...
                new FrmDbToScript(longservername, str7).ShowDialog(this);
            }
        }
            ...
            try
            {
                ...
                if (tables.Count > 0)
                {
                    foreach (string str4 in tables)
                    {
                        ...
                        node5.Tag = "table";
                        node.Nodes.Add(node5);
                        List<ColumnInfo> columnList = obj2.GetColumnList(text, str4);
                        if ((columnList != null) && (columnList.Count > 0))
                        {
                            foreach (ColumnInfo info in columnList)
                            {
            ...
            try
            {
                ...
                if (vIEWs != null)
                {
                    foreach (DataRow row in vIEWs.Select("", "name ASC"))
                    {
                        ...
                        List<ColumnInfo> list3 = obj2.GetColumnList(text, str7);
                        if ((list3 != null) && (list3.Count > 0))
                        {
                            foreach (ColumnInfo info2 in list3)
                            {
            ...
            try
            {
                ...
                if (procs != null)
                {
                    foreach (DataRow row2 in procs.Select("", "name ASC"))
                    {
                        ...
                        List<ColumnInfo> list4 = obj2.GetColumnList(text, str10);
                        if ((list4 != null) && (list4.Count > 0))
                        {
                            foreach (ColumnInfo info3 in list4)
                            {
        ...
        private void 重命名tabItem_Click(object sender, EventArgs e)
        {
            if (this.TreeClickNode != null)
            {
                ...
                IDbObject obj2 = ObjectHelper.CreatDbObj(text);
                FrmRenameForm frm = new FrmRenameForm();
        ...
        private void DbView_ResizeEnd(object sender, EventArgs e)
        {
            if (this.Width <= 200)
            {
                this.Width = 200;
